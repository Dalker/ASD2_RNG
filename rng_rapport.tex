...
%>>>>>>> bea87238752a43f9d065cdf79926d497b965bfaa  <-- ça a été mis par JFR mais
% semble HS 
\begin{figure}
    \begin{center}
...
produisent des suites périodiques, qui possèdent des propriétés qui rend la
...
computationnel est élevé, mais les suites générées peuvent par exemple servir
...
\item Générateur avec la méthode des carrés mentionnée par Von Neumann
  ...
  (suffisamment grand pour éviter 32 bits centraux égaux à 0 après la première
  étape).
